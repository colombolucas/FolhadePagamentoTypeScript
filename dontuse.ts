...
class Pessoa{
    ...
    public pessoa: IPessoa = {} as IPessoa;

    constructor(public id, public nome, public idade, public enderecos){
        this.pessoa.Id = id
...
class Enderecos{
    ...
    public endereco: IEndereco = {} as IEndereco;

    constructor(public id, public logradouro, public numero, public complemento){
        this.endereco.Id = id
...
let pessoa1 = new Pessoa(1, "Lucas Colombo", 27, [1, "Jose bonfante", 21, "Bar"]);
let pessoa2 = new Pessoa(2, "Karen Melegaro", 19, [2, "Jose dos Alfineteiros", 934, "Condominio dos Bruxos"]);
let pessoa3 = new Pessoa(3, "Amanda Rodrigues", 17, [3, "Cardinelio Gonçalves", 234, "Sitio Madeira"]);
let pessoa4 = new Pessoa(4, "Luan Smith", 32, [4, "Rua Felipe Colombo", 1063, "Moradas do Bosque"]);
let pessoa5 = new Pessoa(5, "Marli Abreu", 54, [5, "Jorge Lacerda", 125, "Em frente a padaria"]);
let pessoa6 = new Pessoa(6, "Smigol Tristin", 23, [6, "Alvaro Catão", 666, "Condominio Francesa"]);
let pessoa7 = new Pessoa(7, "Tester testador testado", 20, [7, "Rua dos Tester", 1010, "Em frente a testera"]);
let pessoa8 = new Pessoa(8, "Principe Caspian", 33, [8, "Rua dos nobres", 921, "Condominio da nobreza real"]);
let pessoa9 = new Pessoa(9, "Afrodite", 19, [9, "Rua da Grecia", 334, "Condominio dos Deuses Gregos"]);
let pessoa10 = new Pessoa(10, "Gaspar, o fantasminha camarada", 90, [10, "Rua dos mortos", 934, "Condominio dos que não estão vivos"]);
